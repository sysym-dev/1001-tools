...
<template>
  <div class="grid grid-cols-2 gap-3">
    <base-button fullwidth v-on:click="handleClickGoogle">
      <svg class="h-4 w-4 mr-1" aria-hidden="true" viewBox="0 0 24 24">
        <path
    ...
    <base-button fullwidth v-on:click="handleClickGithub">
      <svg
        class="h-4 w-4 mr-1 fill-[#24292F]"
        aria-hidden="true"
        fill="currentColor"
        viewBox="0 0 20 20"
      >
